...
<link href="../css/materializa.css" rel="stylesheet" />
...
<body class="theme-red">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="javascript:void(0);" class="navbar-toggle collapsed"
					...
					class="bars"></a> <a class="navbar-brand" href="index.html">SunGrow</a>
			</div>
	...
	<section>
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="user-info">
				...
				<div class="info-container">
					<div class="name" data-toggle="dropdown" aria-haspopup="true"
						aria-expanded="false">Rafael</div>
					<div class="email">rafael@example.com</div>
			...
			<div class="legal">
				<div class="copyright">
					&copy; 2018 <a href="javascript:void(0);">Sungrow</a>
				</div>
				<div class="version">
					<b>Version: </b> 0.0.1
				</div>
			...
			<div class="row clearfix">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="info-box bg-pink hover-expand-effect">
						...
						<div class="content">
							<div class="text">Temperatura do Ar</div>
							<div>
								<span id="texto-card">27°C</span>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="info-box bg-cyan hover-expand-effect">
						...
						<div class="content">
							<div class="text">Luminosidade</div>
							<div>
								<span id="texto-card" onload=></span>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="info-box bg-light-green hover-expand-effect">
						...
						<div class="content">
							<div class="text">Umidade do Ar</div>
							<div>
								<span id="texto-card">60%</span>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="info-box bg-orange hover-expand-effect">
						...
						<div class="content">
							<div class="text">Temperatura da Água</div>
							<div>
								<span id="texto-card">30°C</span>
							</div>
						</div>
					</div>
				</div>
